...
function ziss_enqueue_script() {
	...
	if ( is_rtl() ) {
		wp_register_style( 'ziss-frontend-rtl', ZISS_CSS_URL . 'frontend-rtl.css', false, ZISS_VERSION, 'all' );
		wp_enqueue_style( 'ziss-frontend-rtl' );
	}
	...
	wp_register_script( 'waitforimages', ZISS_VENDORS_URL . 'waitForImages/jquery.waitforimages.min.js', array( 'jquery' ), ZISS_VERSION, true );
...
function ziss_core_enqueue_admin_script() {
	...
	if ( in_array( $pagenow, array( 'edit.php', 'post.php', 'post-new.php' ) ) ) {
		if ( 'ziss' == $post_type ) {
			...
			wp_register_style( 'font-awesome', ZISS_VENDORS_URL . 'font-awesome/css/font-awesome.min.css', false, ZISS_VERSION, 'all' );
			wp_enqueue_style( 'font-awesome' );
			
			wp_register_style( 'chosen', ZISS_VENDORS_URL . 'chosen/chosen.min.css', false, ZISS_VERSION, 'all' );
			...
			wp_register_script( 'chosen', ZISS_VENDORS_URL . 'chosen/chosen.jquery.min.js', array( 'jquery' ), ZISS_VERSION, true );
