<?php
include_once( NEXIO_TOOLKIT_PATH . '/includes/classes/welcome.php' );
include_once( NEXIO_TOOLKIT_PATH . '/includes/core/cs-framework.php' );
/* MAILCHIP */
...
if ( !function_exists( 'nexio_toolkit_vc_param' ) ) {
	function nexio_toolkit_vc_param( $key = false, $value = false )
	{
	...
	add_action( 'init', 'nexio_toolkit_vc_param' );
}

function nexio_toolkit_after_setup_theme() {
	// require_once NEXIO_TOOLKIT_PATH . 'includes/classes/import/import.php';
	
	/**
	 * Compress HTML output
	 */
	require_once NEXIO_TOOLKIT_PATH . '/includes/classes/WP_HTML_Compression.php';
}
add_action('after_setup_theme', 'nexio_toolkit_after_setup_theme');