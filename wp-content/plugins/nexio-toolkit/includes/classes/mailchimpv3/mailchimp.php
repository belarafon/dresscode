...
if ( !class_exists( 'FamiMailChimp' ) ) {
	class FamiMailChimp
	{
		...
		public function __construct()
		{
		    ...
		    $mail_chimp_options = get_option('nexio_mailchimp_option', $mail_chimp_options_default);
		...
		{
			wp_enqueue_script( 'fami-mailchimp', NEXIO_TOOLKIT_URL . '/includes/classes/mailchimpv3/mailchimp.js', array( 'jquery' ), '1.0', true );
		...
		{
			$lists   = array();
			$api_key = nexio_toolkit_get_option( 'api_key', '' );
