...
if ( ! class_exists( 'NEXIO_IMPORTER' ) ) {
	class NEXIO_IMPORTER {
		...
		public function __construct() {
			...
			$registed_menu = array(
				'primary' => esc_html__( 'Primary Menu', 'nexio-toolkit' ),
				'privacy' => esc_html__( 'Privacy Vertical Menu', 'nexio-toolkit' ),
			);
			$menu_location = array(
				'primary' => 'Primary Menu',
				'privacy' => 'Privacy Vertical Menu',
			);
			$data_filter   = array(
				'data_demos'    => array(
					array(
						'name'           => esc_html__( 'Home Modern', 'nexio-toolkit' ),
						'slug'           => 'home-modern',
						'menus'          => $registed_menu,
						'homepage'       => 'Home Modern',
						'blogpage'       => 'Blog',
						'preview'        => NEXIO_IMPORTER_URI . '/data/previews/home-modern.jpg',
						'demo_link'      => 'https://nexio.famithemes.com/home-modern/',
						'menu_locations' => $menu_location,
						'theme_option'   => NEXIO_IMPORTER_DIR . '/data/theme-options.txt',
						'content_path'   => NEXIO_IMPORTER_DIR . '/data/content.xml',
						'widget_path'    => NEXIO_IMPORTER_DIR . '/data/widgets.wie',
						'revslider_path' => NEXIO_IMPORTER_DIR . '/data/revsliders/',
					),
					array(
						'name'           => esc_html__( 'Home Stylish', 'nexio-toolkit' ),
						'slug'           => 'home-stylish',
						'menus'          => $registed_menu,
						'homepage'       => 'Home Stylish',
						'blogpage'       => 'Blog',
						'preview'        => NEXIO_IMPORTER_URI . '/data/previews/home-stylish.jpg',
						'demo_link'      => 'https://nexio.famithemes.com/home-stylish/',
						'menu_locations' => $menu_location,
						'theme_option'   => NEXIO_IMPORTER_DIR . '/data/theme-options.txt',
						'content_path'   => NEXIO_IMPORTER_DIR . '/data/content.xml',
						'widget_path'    => NEXIO_IMPORTER_DIR . '/data/widgets.wie',
					...
					array(
						'name'           => esc_html__( 'Home Metro', 'nexio-toolkit' ),
						'slug'           => 'home-metro',
						'menus'          => $registed_menu,
						'homepage'       => 'Home Metro',
						'blogpage'       => 'Blog',
						'preview'        => NEXIO_IMPORTER_URI . '/data/previews/home-metro.jpg',
						'demo_link'      => 'https://nexio.famithemes.com/home-metro/',
						'menu_locations' => $menu_location,
						'theme_option'   => NEXIO_IMPORTER_DIR . '/data/theme-options.txt',
						'content_path'   => NEXIO_IMPORTER_DIR . '/data/content.xml',
						'widget_path'    => NEXIO_IMPORTER_DIR . '/data/widgets.wie',
					...
					array(
						'name'           => esc_html__( 'Home Elegant', 'nexio-toolkit' ),
						'slug'           => 'home-elegant',
						'menus'          => $registed_menu,
						'homepage'       => 'Home Elegant',
						'blogpage'       => 'Blog',
						'preview'        => NEXIO_IMPORTER_URI . '/data/previews/home-elegant.jpg',
						'demo_link'      => 'https://nexio.famithemes.com/home-elegant/',
						'menu_locations' => $menu_location,
						'theme_option'   => NEXIO_IMPORTER_DIR . '/data/theme-options.txt',
						'content_path'   => NEXIO_IMPORTER_DIR . '/data/content.xml',
						'widget_path'    => NEXIO_IMPORTER_DIR . '/data/widgets.wie',
					...
					array(
						'name'           => esc_html__( 'Home Instagram', 'nexio-toolkit' ),
						'slug'           => 'home-instagram',
						'menus'          => $registed_menu,
						'homepage'       => 'Home Instagram',
						'blogpage'       => 'Blog',
						'preview'        => NEXIO_IMPORTER_URI . '/data/previews/home-instagram.jpg',
						'demo_link'      => 'https://nexio.famithemes.com/home-instagram/',
						'menu_locations' => $menu_location,
						'theme_option'   => NEXIO_IMPORTER_DIR . '/data/theme-options.txt',
						'content_path'   => NEXIO_IMPORTER_DIR . '/data/content.xml',
						'widget_path'    => NEXIO_IMPORTER_DIR . '/data/widgets.wie',
						'revslider_path' => NEXIO_IMPORTER_DIR . '/data/revsliders/', // No slider but still import
					),
				),
				'item_import'   => array(
			...
			$import_data   = apply_filters( 'nexio_data_import', $data_filter );
			// SET DATA DEMOS
		...
		public function define_constants() {
			$this->define( 'NEXIO_IMPORTER_DIR', NEXIO_TOOLKIT_PATH . '/includes/classes/import' );
			$this->define( 'NEXIO_IMPORTER_URI', NEXIO_TOOLKIT_URL . '/includes/classes/import' );
		}
		...
		public function register_scripts( $hook_suffix ) {
			if ( $hook_suffix == 'toplevel_page_nexio_menu' ) {
				wp_enqueue_style( 'thickbox' );
				wp_enqueue_style( 'fami-importer-style', NEXIO_IMPORTER_URI . '/assets/circle.css' );
				wp_enqueue_style( 'fami-importer-circle', NEXIO_IMPORTER_URI . '/assets/import.css' );
				wp_enqueue_script( 'thickbox' );
				wp_enqueue_script( 'fami-importer-script', NEXIO_IMPORTER_URI . '/assets/import.js', array( 'jquery' ), false );
			}
		}
            ...
            <div class="fami-importer-wrapper">
                ...
                <div class="note">
                    ...
                    <p>Please ensure you have already installed and
                        activated Nexio Toolkit, WooCommerce, WPBakery Page Builder and Revolution Slider plugins.</p>
		...
		public function before_content_import() {
			if ( class_exists( 'WooCommerce' ) ) {
				...
				if ( current_user_can( 'administrator' ) ) {
					...
					$attributes = apply_filters( 'nexio_import_wooCommerce_attributes', $attributes );
		...
		public function import_full_content() {
			...
			$already_imported_full_data = get_option( 'nexio_already_imported_full_data', 'no' ) == 'yes';
			...
			$this->import_content();
			update_option( 'nexio_already_imported_full_data', 'yes' );
			wp_die();
		}
		...
		public function import_page_content() {
			$already_imported_page = get_option( 'nexio_already_imported_page', 'no' ) == 'yes';
			...
			$this->ajax_options_posttype = array( 'page' );
			$this->import_content();
			update_option( 'nexio_already_imported_page', 'yes' );
			wp_die();
		}
		
		public function import_post_content() {
			$already_imported_post = get_option( 'nexio_already_imported_post', 'no' ) == 'yes';
			...
			$this->import_content();
			update_option( 'nexio_already_imported_post', 'yes' );
			wp_die();
		}
		
		public function import_attachments() {
			$already_imported_attachment = get_option( 'nexio_already_imported_attachment', 'no' ) == 'yes';
			...
			$this->ajax_attachments      = true;
			$this->import_content();
			update_option( 'nexio_already_imported_attachment', 'yes' );
			wp_die();
		}
		
		public function import_product_content() {
			$already_imported_product = get_option( 'nexio_already_imported_product', 'no' ) == 'yes';
			...
			update_option( 'nexio_already_imported_product', 'yes' );
			wp_die();
		}
		...
		public function import_menu() {
			...
			$already_imported_menu = get_option( 'nexio_already_imported_menu', 'no' ) == 'yes';
			...
			$this->import_content();
			update_option( 'nexio_already_imported_menu', 'yes' );
			wp_die();
		}
		...
		public function import_widget() {
			...
			$already_imported_widgets = get_option( 'nexio_already_imported_widgets', 'no' ) == 'yes';
			...
			update_option( 'nexio_already_imported_widgets', 'yes' );
			wp_die();
		}
		...
		public function import_revslider() {
			...
			// Don't import widgets twice
			$already_imported_revslider = get_option( 'nexio_already_imported_revslider', 'no' ) == 'yes';
			...
			update_option( 'nexio_already_imported_revslider', 'yes' );
			wp_die();
		}
		...
		public function update_prdctfltr_settings() {
			...
			if ( class_exists( 'PrdctfltrInit' ) ) {
				$already_imported_prdctfltr_settings = get_option( 'nexio_already_imported_prdctfltr_settings', 'no' ) == 'yes';
				...
				$prdctfltr_settings = array(
					...
					'wc_settings_prdctfltr_version'                          => array(
						'option_value' => '6.6.4',
						'autoload'     => 'yes'
					),
					'prdctfltr_wc_default'                                   => array(
						'option_value' => stripslashes( '{\"wc_settings_prdctfltr_always_visible\":\"no\",\"wc_settings_prdctfltr_click_filter\":\"yes\",\"wc_settings_prdctfltr_show_counts\":\"no\",\"wc_settings_prdctfltr_show_search\":\"no\",\"wc_settings_prdctfltr_selection_area\":[\"topbar\",\"intitle\"],\"wc_settings_prdctfltr_collector\":\"flat\",\"wc_settings_prdctfltr_selected_reorder\":\"no\",\"wc_settings_prdctfltr_tabbed_selection\":\"no\",\"wc_settings_prdctfltr_disable_bar\":\"no\",\"wc_settings_prdctfltr_disable_sale\":\"yes\",\"wc_settings_prdctfltr_disable_instock\":\"yes\",\"wc_settings_prdctfltr_disable_reset\":\"no\",\"wc_settings_prdctfltr_custom_action\":\"\",\"wc_settings_prdctfltr_noproducts\":\"\",\"wc_settings_prdctfltr_style_preset\":\"pf_default\",\"wc_settings_prdctfltr_style_mode\":\"pf_mod_multirow\",\"wc_settings_prdctfltr_max_columns\":\"4\",\"wc_settings_prdctfltr_limit_max_height\":\"no\",\"wc_settings_prdctfltr_max_height\":\"350\",\"wc_settings_prdctfltr_custom_scrollbar\":\"no\",\"wc_settings_prdctfltr_style_checkboxes\":\"prdctfltr_round\",\"wc_settings_prdctfltr_style_hierarchy\":\"prdctfltr_hierarchy_circle\",\"wc_settings_prdctfltr_button_position\":\"bottom\",\"wc_settings_prdctfltr_icon\":\"\",\"wc_settings_prdctfltr_title\":\"\",\"wc_settings_prdctfltr_submit\":\"\",\"wc_settings_prdctfltr_loader\":\"css-spinner-full-01\",\"wc_settings_prdctfltr_adoptive\":\"no\",\"wc_settings_prdctfltr_adoptive_mode\":\"permalink\",\"wc_settings_prdctfltr_adoptive_style\":\"pf_adptv_default\",\"wc_settings_prdctfltr_adoptive_depend\":\"\",\"wc_settings_prdctfltr_show_counts_mode\":\"default\",\"wc_settings_prdctfltr_adoptive_reorder\":\"yes\",\"wc_settings_prdctfltr_mobile_preset\":\"default\",\"wc_settings_prdctfltr_mobile_resolution\":\"640\",\"wc_settings_prdctfltr_cat_title\":\"\",\"wc_settings_prdctfltr_cat_description\":\"\",\"wc_settings_prdctfltr_include_cats\":null,\"wc_settings_prdctfltr_cat_orderby\":\"\",\"wc_settings_prdctfltr_cat_order\":\"ASC\",\"wc_settings_prdctfltr_cat_limit\":\"0\",\"wc_settings_prdctfltr_cat_hierarchy\":\"yes\",\"wc_settings_prdctfltr_cat_mode\":\"showall\",\"wc_settings_prdctfltr_cat_hierarchy_mode\":\"no\",\"wc_settings_prdctfltr_cat_multi\":\"no\",\"wc_settings_prdctfltr_cat_relation\":\"IN\",\"wc_settings_prdctfltr_cat_selection\":\"no\",\"wc_settings_prdctfltr_cat_adoptive\":\"no\",\"wc_settings_prdctfltr_cat_none\":\"yes\",\"wc_settings_prdctfltr_cat_term_customization\":\"\",\"wc_settings_prdctfltr_pa_color_title\":\"\",\"wc_settings_prdctfltr_pa_color_description\":\"\",\"wc_settings_prdctfltr_include_pa_color\":[\"black\",\"blue\",\"brown\",\"green\",\"red\",\"white\",\"yellow\"],\"wc_settings_prdctfltr_pa_color\":\"pf_attr_text\",\"wc_settings_prdctfltr_pa_color_orderby\":\"\",\"wc_settings_prdctfltr_pa_color_order\":\"ASC\",\"wc_settings_prdctfltr_pa_color_limit\":\"0\",\"wc_settings_prdctfltr_pa_color_hierarchy\":\"no\",\"wc_settings_prdctfltr_pa_color_hierarchy_mode\":\"no\",\"wc_settings_prdctfltr_pa_color_multi\":\"no\",\"wc_settings_prdctfltr_pa_color_relation\":\"IN\",\"wc_settings_prdctfltr_pa_color_selection\":\"no\",\"wc_settings_prdctfltr_pa_color_adoptive\":\"no\",\"wc_settings_prdctfltr_pa_color_none\":\"no\",\"wc_settings_prdctfltr_pa_color_term_customization\":\"wc_settings_prdctfltr_term_customization_5c638d7513cd3\",\"wc_settings_prdctfltr_pa_brand_title\":\"\",\"wc_settings_prdctfltr_pa_brand_description\":\"\",\"wc_settings_prdctfltr_include_pa_brand\":null,\"wc_settings_prdctfltr_pa_brand\":\"pf_attr_text\",\"wc_settings_prdctfltr_pa_brand_orderby\":\"\",\"wc_settings_prdctfltr_pa_brand_order\":\"ASC\",\"wc_settings_prdctfltr_pa_brand_limit\":\"0\",\"wc_settings_prdctfltr_pa_brand_hierarchy\":\"no\",\"wc_settings_prdctfltr_pa_brand_hierarchy_mode\":\"no\",\"wc_settings_prdctfltr_pa_brand_multi\":\"no\",\"wc_settings_prdctfltr_pa_brand_relation\":\"IN\",\"wc_settings_prdctfltr_pa_brand_selection\":\"no\",\"wc_settings_prdctfltr_pa_brand_adoptive\":\"no\",\"wc_settings_prdctfltr_pa_brand_none\":\"no\",\"wc_settings_prdctfltr_pa_brand_term_customization\":\"\",\"wc_settings_prdctfltr_active_filters\":[\"cat\",\"range\",\"pa_color\",\"pa_brand\"],\"wc_settings_prdctfltr_perpage_title\":\"\",\"wc_settings_prdctfltr_perpage_description\":\"\",\"wc_settings_prdctfltr_perpage_label\":\"\",\"wc_settings_prdctfltr_perpage_range\":\"20\",\"wc_settings_prdctfltr_perpage_range_limit\":\"5\",\"wc_settings_prdctfltr_perpage_term_customization\":\"\",\"wc_settings_prdctfltr_perpage_filter_customization\":\"\",\"wc_settings_prdctfltr_vendor_title\":\"\",\"wc_settings_prdctfltr_vendor_description\":\"\",\"wc_settings_prdctfltr_include_vendor\":null,\"wc_settings_prdctfltr_vendor_term_customization\":\"\",\"wc_settings_prdctfltr_instock_title\":\"\",\"wc_settings_prdctfltr_instock_description\":\"\",\"wc_settings_prdctfltr_instock_term_customization\":\"\",\"wc_settings_prdctfltr_orderby_title\":\"Price\",\"wc_settings_prdctfltr_orderby_description\":\"Price: $30 — $3450\",\"wc_settings_prdctfltr_include_orderby\":[\"menu_order\",\"popularity\",\"rating\",\"date\",\"price\",\"price-desc\"],\"wc_settings_prdctfltr_orderby_none\":\"no\",\"wc_settings_prdctfltr_orderby_term_customization\":\"\",\"wc_settings_prdctfltr_search_title\":\"\",\"wc_settings_prdctfltr_search_description\":\"\",\"wc_settings_prdctfltr_search_placeholder\":\"\",\"wc_settings_prdctfltr_price_title\":\"\",\"wc_settings_prdctfltr_price_description\":\"\",\"wc_settings_prdctfltr_price_range\":\"100\",\"wc_settings_prdctfltr_price_range_add\":\"100\",\"wc_settings_prdctfltr_price_range_limit\":\"6\",\"wc_settings_prdctfltr_price_none\":\"no\",\"wc_settings_prdctfltr_price_term_customization\":\"\",\"wc_settings_prdctfltr_price_filter_customization\":\"\",\"wc_settings_prdctfltr_tag_title\":\"\",\"wc_settings_prdctfltr_tag_description\":\"\",\"wc_settings_prdctfltr_include_tags\":null,\"wc_settings_prdctfltr_tag_orderby\":\"\",\"wc_settings_prdctfltr_tag_order\":\"ASC\",\"wc_settings_prdctfltr_tag_limit\":\"0\",\"wc_settings_prdctfltr_tag_multi\":\"no\",\"wc_settings_prdctfltr_tag_relation\":\"IN\",\"wc_settings_prdctfltr_tag_selection\":\"no\",\"wc_settings_prdctfltr_tag_adoptive\":\"no\",\"wc_settings_prdctfltr_tag_none\":\"no\",\"wc_settings_prdctfltr_tag_term_customization\":\"\",\"wc_settings_prdctfltr_custom_tax_title\":\"\",\"wc_settings_prdctfltr_custom_tax_description\":\"\",\"wc_settings_prdctfltr_include_chars\":null,\"wc_settings_prdctfltr_custom_tax_orderby\":\"\",\"wc_settings_prdctfltr_custom_tax_order\":\"ASC\",\"wc_settings_prdctfltr_custom_tax_limit\":\"0\",\"wc_settings_prdctfltr_chars_multi\":\"no\",\"wc_settings_prdctfltr_custom_tax_relation\":\"IN\",\"wc_settings_prdctfltr_chars_selection\":\"no\",\"wc_settings_prdctfltr_chars_adoptive\":\"no\",\"wc_settings_prdctfltr_chars_none\":\"no\",\"wc_settings_prdctfltr_chars_term_customization\":\"\",\"wc_settings_prdctfltr_pa_details_title\":\"\",\"wc_settings_prdctfltr_pa_details_description\":\"\",\"wc_settings_prdctfltr_include_pa_details\":null,\"wc_settings_prdctfltr_pa_details\":\"pf_attr_text\",\"wc_settings_prdctfltr_pa_details_orderby\":\"\",\"wc_settings_prdctfltr_pa_details_order\":\"ASC\",\"wc_settings_prdctfltr_pa_details_limit\":\"0\",\"wc_settings_prdctfltr_pa_details_hierarchy\":\"no\",\"wc_settings_prdctfltr_pa_details_hierarchy_mode\":\"no\",\"wc_settings_prdctfltr_pa_details_multi\":\"no\",\"wc_settings_prdctfltr_pa_details_relation\":\"IN\",\"wc_settings_prdctfltr_pa_details_selection\":\"no\",\"wc_settings_prdctfltr_pa_details_adoptive\":\"no\",\"wc_settings_prdctfltr_pa_details_none\":\"no\",\"wc_settings_prdctfltr_pa_details_term_customization\":\"\",\"wc_settings_prdctfltr_pa_tivi_details_title\":\"\",\"wc_settings_prdctfltr_pa_tivi_details_description\":\"\",\"wc_settings_prdctfltr_include_pa_tivi_details\":null,\"wc_settings_prdctfltr_pa_tivi_details\":\"pf_attr_text\",\"wc_settings_prdctfltr_pa_tivi_details_orderby\":\"\",\"wc_settings_prdctfltr_pa_tivi_details_order\":\"ASC\",\"wc_settings_prdctfltr_pa_tivi_details_limit\":\"0\",\"wc_settings_prdctfltr_pa_tivi_details_hierarchy\":\"no\",\"wc_settings_prdctfltr_pa_tivi_details_hierarchy_mode\":\"no\",\"wc_settings_prdctfltr_pa_tivi_details_multi\":\"no\",\"wc_settings_prdctfltr_pa_tivi_details_relation\":\"IN\",\"wc_settings_prdctfltr_pa_tivi_details_selection\":\"no\",\"wc_settings_prdctfltr_pa_tivi_details_adoptive\":\"no\",\"wc_settings_prdctfltr_pa_tivi_details_none\":\"no\",\"wc_settings_prdctfltr_pa_tivi_details_term_customization\":\"\",\"wc_settings_prdctfltr_range_filters\":{\"pfr_title\":[\"Price\"],\"pfr_description\":[\"Price: <span>$64 — $2,351</span>\"],\"pfr_taxonomy\":[\"price\"],\"pfr_include\":[null],\"pfr_order\":[\"ASC\"],\"pfr_orderby\":[\"\"],\"pfr_style\":[\"flat\"],\"pfr_grid\":[\"no\"],\"pfr_custom\":[\"\"],\"pfr_adoptive\":[\"no\"]}}' ),
						'autoload'     => 'no'
					),
					'wc_settings_prdctfltr_term_customization_5c638c742c6a4' => array(
						'option_value' => unserialize( 'a:2:{s:5:"style";s:5:"color";s:8:"settings";a:7:{s:10:"term_black";s:7:"#111111";s:9:"term_blue";s:7:"#4472a3";s:10:"term_brown";s:7:"#987b6a";s:10:"term_green";s:7:"#7fab5c";s:8:"term_red";s:7:"#e12300";s:10:"term_white";s:7:"#ffffff";s:11:"term_yellow";s:7:"#ffc84b";}}' ),
						'autoload'     => 'no'
					),
					'wc_settings_prdctfltr_term_customization_5c638d7513cd3' => array(
						'option_value' => unserialize( 'a:2:{s:5:"style";s:5:"color";s:8:"settings";a:7:{s:10:"term_black";s:7:"#111111";s:9:"term_blue";s:7:"#4472a3";s:10:"term_brown";s:7:"#987b6a";s:10:"term_green";s:7:"#7fab5c";s:8:"term_red";s:7:"#e12300";s:10:"term_white";s:7:"#ffffff";s:11:"term_yellow";s:7:"#ffc84b";}}' ),
						'autoload'     => 'no'
					),
					...
					'wc_settings_prdctfltr_ajax_class'                       => array(
						'option_value' => '.products:not(.owl-carousel)',
						'autoload'     => 'yes'
					),
				...
				update_option( 'nexio_already_imported_prdctfltr_settings', 'yes' );
			}
		}
		...
		public function update_sales_popup_settings() {
			...
			if ( class_exists( 'famiSalesPopup' ) ) {
				// Import Sales Popup
				$already_imported_sales_popup = get_option( 'nexio_already_imported_sales_popup', 'no' ) == 'yes';
				if ( ! $already_imported_sales_popup ) {
					return;
				}
				
				// NEXIO_IMPORTER_URI
				if ( file_exists( NEXIO_IMPORTER_DIR . 'data-sample/sale-popup-data.txt' ) ) {
					$sales_popup_response_data = wp_remote_get( NEXIO_IMPORTER_URI . 'data-sample/sale-popup-data.txt' );
					...
					update_option( 'nexio_already_imported_sales_popup', 'yes' );
				}
			}
		}
	}
