...
class Nexio_Mapper {
	 ...
	 * @var  string
	 */
	protected static $prefix = 'Nexio_Mapper_';
	...
	public static function initialize() {
		...
		Nexio_Mapper_Post_Type::initialize();

		// Initialize shortcode.
		Nexio_Mapper_Shortcode::initialize();
	...
	public static function autoload( $class_name ) {
		...
		$base = NEXIO_TOOLKIT_PATH . '/includes/classes/mapper/includes/';
