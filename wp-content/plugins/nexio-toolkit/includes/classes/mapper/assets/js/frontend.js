jQuery(function ($) {
    ...
    $(document).ready(function () {
        var renderPin = function () {
            var map = $('.mapper'), pin = $('.csre-pin'), _img_width = map.data('width'),
        ...
        var initPopup = function () {
            ...
            pin.on('click', function () {
                    ...
                    if (ww <= 767) {
                        ...
                        $('.mapper .csre-pin .csre-popup-header h2').css('max-width', popup_width - 10);
                        ...
                        setTimeout(function () {
                            ...
                            $('.mapper .csre-pin.actived').removeClass('actived');
            ...
            pin.hover(function () {
                ...
                flag = false;
                _this.closest('.mapper').children('img').removeAttr('style');
