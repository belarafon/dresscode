<?php
    ...
    // Get current image.
    $attachment_id = get_post_meta($post->ID, 'nexio_mapper_image', true);
    ...
    $settings = get_post_meta($post->ID, 'nexio_mapper_settings', true);

    // Get all pins.
    $pins = get_post_meta($post->ID, 'nexio_mapper_pins', true);
?>
<script type="text/html" id="nexio_mapper_tmpl">
    <div class="mapper-wrap">
        <div class="mapper-top">
            <div class="title">
                <input type="text" name="post_title" class="input-text" placeholder="<?php
                    _e('Enter Title Here', 'nexio-toolkit');
                ?>" value="<?php
                    esc_attr_e($post->post_title);
                ?>">
            </div>
        </div><!-- .mapper-top -->
        <div class="mapper bdgr bgw">
            <div class="mapper-mid fc aic jcsb pd__20 bggr">
                <div class="global-setting fc aic">
                    <div id="general-settings">
                        <a href="javascript:void(0)" class="btn br__3 dib">
                            <i class="wricon-cog mr__5"></i>
                            <?php _e('General Settings', 'nexio-toolkit'); ?>
                        </a>
                        ...
                        <div class="setting-box general-setting br__3 bgw bdgr">
                            ...
                            <ul class="nav mg__0 fc">
                                <li data-nav="style"
                                    class="mg__0 active"><?php _e('Style Settings', 'nexio-toolkit'); ?></li>
                                <!-- <li data-nav="image-effect" class="mg__0"><?php _e('Image Effect', 'nexio-toolkit'); ?></li> -->
                            </ul>

                            <div class="tab-content">
                                <div data-tab="style" class="tab-item">
                                    <label class="db mb__10"><?php _e('Popup size', 'nexio-toolkit'); ?></label>
                                    <div class="row mb__25">
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Width', 'nexio-toolkit'); ?></label>
                                        ...
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Height', 'nexio-toolkit'); ?></label>
                                            <div class="input-unit pr">
                                    ...
                                    <div class="row">
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Tooltip style', 'nexio-toolkit'); ?></label>
                                            <div class="select-styled pr">
                                                <select name="tooltip-style" class="slt select-large">
                                                    <option value="light"><?php _e('Light', 'nexio-toolkit'); ?></option>
                                                    <option value="dark"><?php _e('Dark', 'nexio-toolkit'); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Popup box shadow', 'nexio-toolkit'); ?></label>
                                        ...
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Popup show fffect', 'nexio-toolkit'); ?></label>
                                            <div class="select-styled pr">
                                                <select name="popup-show-effect" class="slt select-large">
                                                    <option value="fade"><?php _e('Fade In', 'nexio-toolkit'); ?></option>
                                                    <option value="slide-left"><?php _e('Slide From Left', 'nexio-toolkit'); ?></option>
                                                    <option value="slide-right"><?php _e('Slide From Right', 'nexio-toolkit'); ?></option>
                                                    <option value="slide-top"><?php _e('Slide From Top', 'nexio-toolkit'); ?></option>
                                                    <option value="slide-bottom"><?php _e('Slide From Bottom', 'nexio-toolkit'); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Popup border radius', 'nexio-toolkit'); ?></label>
                                            <div class="input-unit pr">
                                        ...
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Popup border width', 'nexio-toolkit'); ?></label>
                                            <div class="input-unit pr">
                                        ...
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Popup border color', 'nexio-toolkit'); ?></label>
                                    ...
                                    <div class="row">
                                        <div class="cm-4">
                                            <label class="db mb__10"><?php _e('Image effect', 'nexio-toolkit'); ?></label>
                                            <div class="select-styled pr">
                                                <select name="image-effect" class="slt select-large">
                                                    <option value="none"><?php _e('None', 'nexio-toolkit'); ?></option>
                                                    <option value="blur"><?php _e('Blur', 'nexio-toolkit'); ?></option>
                                                    <option value="gray"><?php _e('Gray', 'nexio-toolkit'); ?></option>
                                                    <option value="mask"><?php _e('Mask Overlay', 'nexio-toolkit'); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="cm-4" data-image-effect="mask">
                                            <label class="db mb__10"><?php _e('Mask color', 'nexio-toolkit'); ?></label>
                                            <div class="picker-styled pr">
                    ...
                    <div class="nexio-copy-shortcode">
                        <span class="shortcode-name"><?php echo esc_html__('Copy Shortcode','nexio')?></span>
                        <input id="shortcode-syntax" class="shortcode-syntax" value='[nexio_mapper id="<?php echo absint($post->ID); ?>"]'>
                    </div>
                </div>
            </div><!-- .mapper-mid -->

            <div class="mapper-bot pr aic fc jcc <?php if ($attachment_id) echo 'pr'; ?>">
                <input type="hidden" id="nexio_mapper_image" name="nexio_mapper_image"
                       value="<?php echo absint($attachment_id); ?>">

                <?php if ($attachment_id) : ?>
                    <div class="edit-image pr">
                        <a id="change-image" href="#" class="btn-change-image pa db br__3">
                            <i class="wricon-camera mr__5"></i><?php _e('Change Image', 'nexio-toolkit'); ?>
                        </a>
                ...
                <?php else : ?>
                    <div class="add-image">
                        ...
                        <span class="empty-mapper"><?php _e('Add your image mapping', 'nexio-toolkit'); ?></span>
                    </div>
                <?php endif; ?>
            </div><!-- .mapper-bot -->
        </div><!-- .mapper -->
...
<script type="text/html" id="nexio_mapper_image_tmpl">
    <div class="edit-image pr">
        <a id="change-image" href="#" class="btn-change-image pa db br__3">
            <i class="fa fa-camera-retro mr__5" aria-hidden="true"></i><?php _e('Change Image', 'nexio-toolkit'); ?>
        </a>
...
<script type="text/html" id="nexio_mapper_pin_tmpl">
    ...
    <div class="setting-box pin-setting br__3 bgw bdgr">
        <h4 class="mg__0 pr">
            <?php _e('Pin Settings', 'nexio-toolkit'); ?>
            <i class="close-box pa">x</i>
        </h4>
        ...
        <ul class="nav mg__0 fc">
            <li data-nav="general" class="mg__0 active"><?php _e('General', 'nexio-toolkit'); ?></li>
            <li data-nav="icon-settings" class="mg__0"><?php _e('Icon Settings', 'nexio-toolkit'); ?></li>
            <li data-nav="popup-settings" class="mg__0"><?php _e('Popup Settings', 'nexio-toolkit'); ?></li>
        </ul>
        ...
        <div class="tab-content">
            <div data-tab="general" class="tab-item">
                <div class="radio-group fc mb__25">
                    <div class="item-styled">
                        <label class="pr">
                            ...
                            <span></span>
                            <?php _e('WooCommerce', 'nexio-toolkit'); ?>
                        </label>
                    </div>
                    <div class="item-styled">
                        <label class="pr">
                ...
                <div class="form-input mb__25" data-pin-type="woocommerce">
                    <label class="db mb__10"><?php _e('Select product', 'nexio-toolkit'); ?></label>
                    ...
                    <div class="item-styled">
                        <label class="pr">
                            ...
                            <input type="checkbox" onchange="jQuery(this).prev().val(this.checked ? 1 : 0);"
                                   checked="checked">
                            <span></span>
                            <?php _e('Show thumbnail', 'nexio-toolkit'); ?>
                        </label>
                    </div>
                    <div class="item-styled">
                        <label class="pr">
                            ...
                            <input type="checkbox" onchange="jQuery(this).prev().val(this.checked ? 1 : 0);"
                                   checked="checked">
                            <span></span>
                            <?php _e('Show description', 'nexio-toolkit'); ?>
                        </label>
                    </div>
                    <div class="item-styled">
                        <label class="pr">
                            ...
                            <input type="checkbox" onchange="jQuery(this).prev().val(this.checked ? 1 : 0);"
                                   checked="checked">
                            <span></span>
                            <?php _e('Show rate', 'nexio-toolkit'); ?>
                        </label>
                    </div>
                </div>
                ...
                <div class="form-input mb__25" data-pin-type="image|text|link">
                    <label class="db mb__10"><?php _e('Popup title', 'nexio-toolkit'); ?></label>
                    <input type="text" data-option="settings[popup-title]" class="input-text input-large" value=""
                           placeholder="<?php
                               _e('Input a title for the popup here...', 'nexio-toolkit');
                           ?>">
                </div>

                <!-- Image Settings -->
                <div class="input-group mb__25" data-pin-type="image">
                    <label class="db mb__10"><?php _e('Select image', 'nexio-toolkit'); ?></label>
                    <div class="pr">
                ...
                <div class="row mb__25" data-pin-type="image|link">
                    <div class="cm-7">
                        <div class="form-input">
                            <label class="db mb__10"><?php _e('Link To', 'nexio-toolkit'); ?></label>
                            <input type="text" data-option="settings[image-link-to]" class="input-text input-large"
                                   value="">
                        </div>
                    </div>
                    <div class="cm-5">
                        <label class="db mb__10"><?php _e('Target', 'nexio-toolkit'); ?></label>
                        <div class="select-styled pr">
                            <select data-option="settings[image-link-target]" class="slt select-large">
                                <option value="_self"><?php _e('Default', 'nexio-toolkit'); ?></option>
                                <option value="_blank"><?php _e('New Tab', 'nexio-toolkit'); ?></option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-input" data-pin-type="text">
                    <label class="db mb__10"><?php _e('Text Content', 'nexio-toolkit'); ?></label>
                    <textarea data-option="settings[text]" rows="6" placeholder="<?php
                        _e('Input some content for the popup here...', 'nexio-toolkit');
                    ?>"></textarea>
                </div>
                <!-- End Text Settings -->
            </div>
                ...
                <div class="radio-group fc mb__25">
                    <div class="item-styled">
                        <label class="pr">
                            ...
                            <span></span>
                            <?php _e('Area Text', 'nexio-toolkit'); ?>
                        </label>
                    </div>
                    <div class="item-styled">
                        <label class="pr">
                ...
                <div data-icon-type="icon-area">
                    <div class="row mb__20">
                        <div class="cm-4 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Text', 'nexio-toolkit' ); ?></label>
                            <input type="text" data-option="settings[area-text]" class="text-custom input-text input-large" value="">
                        </div>
                        <div class="cm-4 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Font Size', 'nexio-toolkit' ); ?></label>
                        ...
                        <div class="cm-4 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Text Color', 'nexio-toolkit' ); ?></label>
                            <div class="picker-styled pr">
                    ...
                    <div class="row">
                        <div class="cm-6 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Background', 'nexio-toolkit' ); ?></label>
                            <div class="picker-styled pr">
                        ...
                        <div class="cm-6 mb__25">
                            <label class="db mb__10"><?php esc_html_e( 'Border Color', 'nexio-toolkit' ); ?></label>
                            <div class="picker-styled pr">
            ...
            <div data-tab="popup-settings" class="tab-item hidden">
                <label class="db mb__10"><?php _e('Custom popup size', 'nexio-toolkit'); ?></label>
                <div class="row">
                    <div class="cm-4">
                        <label class="db mb__10"><?php _e('Width', 'nexio-toolkit'); ?></label>
                        <div class="input-unit pr">
                    ...
                    <div class="cm-4">
                        <label class="db mb__10"><?php _e('Position', 'nexio-toolkit'); ?></label>
                        <div class="select-styled pr">
                            <select data-option="settings[popup-position]" class="slt select-large">
                                <option value="right"><?php _e('Right', 'nexio-toolkit'); ?></option>
                                <option value="left"><?php _e('Left', 'nexio-toolkit'); ?></option>
                                <option value="top"><?php _e('Top', 'nexio-toolkit'); ?></option>
                                <option value="bottom"><?php _e('Bottom', 'nexio-toolkit'); ?></option>
                            </select>
                        </div>
                    </div>
                </div>
...
?>
<script type="text/html" id="nexio_mapper_icon_selector_tmpl">
    <div class="icon-selector select-styled pr bdgr br__3">
        ...
        <div class="icon-wrap pa bdgr">
            <h5><?php _e('Select icon', 'nexio-toolkit'); ?><i class="close fa fa-close"></i></h5>
            <div class="nexio-icon-list bgw bdgr fc fcw">
...
<script type="text/javascript">
    jQuery(function ($) {
        $(window).load(function () {
            // Override default UI.
            var form = $($('#nexio_mapper_tmpl').text()).prepend($('#post').children('input[type="hidden"]'));
            ...
            setTimeout(function () {
                $(document).trigger('init_nexio_mapper');
            }, 500);

            // Pass data to client-side.
            window.nexio_mapper_settings = <?php echo json_encode($settings ? $settings : new stdClass()); ?>;
            window.nexio_mapper_pins = <?php echo json_encode($pins ? array_values($pins) : array()); ?>;
        });
    });
</script>
