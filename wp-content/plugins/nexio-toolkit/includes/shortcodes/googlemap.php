<?php
if ( ! class_exists( 'Nexio_Shortcode_Googlemap' ) ) {
	class Nexio_Shortcode_Googlemap extends Nexio_Shortcode {
		/**
		 * Shortcode name.
		 *
		 * @var  string
		...
		public function output_html( $atts, $content = null ) {
			$atts = function_exists( 'vc_map_get_attributes' ) ? vc_map_get_attributes( 'nexio_googlemap', $atts ) : $atts;
			// Extract shortcode parameters.
			extract( $atts );
			$css_class   = array( 'nexio-google-maps' );
			...
			return apply_filters( 'nexio_shortcode_googlemap', force_balance_tags( $html ), $atts, $content );
		}
	}
}