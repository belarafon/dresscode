<nav class="newnaw nav-tab-wrapper woo-nav-tab-wrapper">
					<a href="admin.php?page=morkvaup_plugin" class="nav-tab  ">Налаштування</a><a href="admin.php?page=morkvaup_invoice" class="nav-tab">Нове відправлення</a><a href="admin.php?page=morkvaup_invoices" class="nav-tab ">Мої відправлення</a><a href="admin.php?page=morkvaup_about" class="nav-tab   nav-tab-active ">Про плагін</a></nav>
					<div class="container">
					<div class="row">
