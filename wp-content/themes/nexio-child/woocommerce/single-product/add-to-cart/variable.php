...
<?php  if ( $enable_single_product_mobile && nexio_is_mobile() ) { ?>
    <form class="variations_form cart variable_mobile" method="post" enctype='multipart/form-data'
        ...
        <?php if ( empty( $available_variations ) && false !== $available_variations ) : ?>
            <p class="stock out-of-stock"><?php echo esc_html__( 'This product is currently out of stock and unavailable.', 'nexio' ); ?></p>
        <?php else : ?>
