...
?>
<header id="header"
        class="site-header header style-09 <?php echo esc_attr( $header_class ); ?>">
    <div class="header-main-inner">
        <div class="header-wrap">
            <?php get_template_part( 'template-parts/header', 'topbar' ); ?>
            <div class="header-wrap-stick">
                <div class="header-position">
                    <div class="header-container nexio-dropdown">
                        <div class="main-menu-wrapper"></div>
                        <div class="header-table" style="<?php echo esc_attr( $css ) ?>">
                            <div class="header-left">
                                <a class="link-horizon" data-nexio="nexio-dropdown" href="#">
                                    <span></span>
                                    <span></span>
                                    <span></span>
                                </a>
