...
?>
<header id="header"
        class="site-header header style-08 <?php echo esc_attr( $header_class ); ?>">
                        ...
                        <div class="header-table" style="<?php echo esc_attr( $css ) ?>">
                            <div class="header-left">
                                <div class="header-menu horizon-menu nexio-dropdown">
                                    <a class="vertical-btn" data-nexio="nexio-dropdown" href="#">
                                        <span></span>
                                        <span></span>
                                        <span></span>
                                    </a>
                                    <div class="main-header-content">
                                        <a class="btn-close" data-nexio="nexio-dropdown" href="#">
